tinymce.init({
    ...
    menu: {
        file: { title: 'Arquivo', items: 'newdocument restoredraft | preview ' },
        edit: { title: 'Edição', items: 'undo redo | cut copy paste | selectall | searchreplace' },
        ...
        table: { title: 'Tabelas', items: 'inserttable | cell row column | tableprops deletetable' },
